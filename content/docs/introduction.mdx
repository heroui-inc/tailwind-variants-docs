---
title: "Introduction"
description: "Learn what Tailwind Variants is and its key features."
---

import { WindowResizer, TVComponent, SlotsExample } from '@/components';
...
**Tailwind Variants** is a first-class variant API library for [TailwindCSS](https://tailwindcss.com/).
...
**Tailwind Variants** resolves conflicting Tailwind classes on the default build. When enabled (the default), it efficiently merges your classes so you don't have to worry about TailwindCSS class conflicts. Use `/lite` if you don't need merge. See [Conflict Resolution](/docs/conflict-resolution).
...
**Tailwind Variants** supports `Tailwindcss v4`. You can check more details in the [Tailwind v4](/docs/tailwind-v4) guide.
...
These improvements make Tailwind Variants even more efficient for large-scale applications.
