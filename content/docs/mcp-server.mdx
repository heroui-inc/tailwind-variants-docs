...
The same server also answers at `/mcp` and `/.well-known/mcp`, and a JSON manifest (endpoint, transport, tool list) is published at [`/.well-known/mcp.json`](https://www.tailwind-variants.org/.well-known/mcp.json).
