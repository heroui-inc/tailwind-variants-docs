...
Yes (v3.4+) — pass a non-empty array and parents merge left to right:
...
Conflict resolution likely merged it away — the last conflicting utility wins ([Class Resolution](/docs/class-resolution)). To see exactly which classes were dropped and by what, enable the experimental [debug mode](/docs/debugging) in development:
