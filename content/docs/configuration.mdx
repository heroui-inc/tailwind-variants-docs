...
The config object also accepts the experimental `debug` flag (v3.4+) for tracing how a recipe resolves — development-only, with no production cost. See [Debugging](/docs/debugging).
