...
const navbar = (
  <Navbar
    chatLink="https://discord.gg/9b6yyZKmH4"
    logo={
    ...
    projectLink="https://github.com/heroui-inc/tailwind-variants"
  />
);
...
const footer = (
  <Footer className="flex-col items-center sm:items-start">
    <div className="flex w-full flex-col items-center sm:items-start">
      ...
      <div className="mt-6 flex flex-col items-start justify-center gap-3 text-xs">
        <p className="text-sm">
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <a
            className="text-inherit"
            href="https://github.com/heroui-inc"
            rel="noreferrer"
            target="_blank"
          >
            <span>GitHub</span>
...
const RootLayout = async ({ children }: { children: ReactNode }) => {
  ...
  return (
    ...
    >
      ...
      <body>
        <Layout
          docsRepositoryBase="https://github.com/heroui-inc/tailwind-variants-docs/blob/main"
          footer={footer}
          navbar={navbar}
